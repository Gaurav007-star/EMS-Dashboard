...
exports.buildOrgTree = exports.willCreateCircularReporting = void 0;
const Employee_1 = require("../models/Employee");
/**
 * Checks if assigning newManagerId as reportingManager for employeeId will create a cycle.
 * Returns true if a cycle is detected, false otherwise.
 */
const willCreateCircularReporting = async (employeeId, newManagerId) => {
    if (!newManagerId)
        return false;
    ...
    while (currentId) {
        const manager = await Employee_1.Employee.findById(currentId);
        if (!manager)
            break;
...
exports.willCreateCircularReporting = willCreateCircularReporting;
/**
